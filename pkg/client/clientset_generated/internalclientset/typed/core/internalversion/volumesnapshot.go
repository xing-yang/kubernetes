...
type VolumeSnapshotInterface interface {
	Create(*core.VolumeSnapshot) (*core.VolumeSnapshot, error)
	Update(*core.VolumeSnapshot) (*core.VolumeSnapshot, error)
	UpdateStatus(*core.VolumeSnapshot) (*core.VolumeSnapshot, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*core.VolumeSnapshot, error)
	List(opts v1.ListOptions) (*core.VolumeSnapshotList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *core.VolumeSnapshot, err error)
...
func newVolumeSnapshots(c *CoreClient, namespace string) *volumeSnapshots {
...
func (c *volumeSnapshots) Get(name string, options v1.GetOptions) (result *core.VolumeSnapshot, err error) {
	result = &core.VolumeSnapshot{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *volumeSnapshots) List(opts v1.ListOptions) (result *core.VolumeSnapshotList, err error) {
	result = &core.VolumeSnapshotList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("volumesnapshots").
...
func (c *volumeSnapshots) Create(volumeSnapshot *core.VolumeSnapshot) (result *core.VolumeSnapshot, err error) {
	result = &core.VolumeSnapshot{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("volumesnapshots").
...
func (c *volumeSnapshots) Update(volumeSnapshot *core.VolumeSnapshot) (result *core.VolumeSnapshot, err error) {
	result = &core.VolumeSnapshot{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("volumesnapshots").
...
func (c *volumeSnapshots) UpdateStatus(volumeSnapshot *core.VolumeSnapshot) (result *core.VolumeSnapshot, err error) {
	result = &core.VolumeSnapshot{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("volumesnapshots").
...
func (c *volumeSnapshots) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *core.VolumeSnapshot, err error) {
	result = &core.VolumeSnapshot{}
