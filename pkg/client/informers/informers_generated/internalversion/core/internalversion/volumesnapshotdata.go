	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Core().VolumeSnapshotDatas().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Core().VolumeSnapshotDatas().Watch(options)
			},
		},
		&core.VolumeSnapshotData{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeSnapshotDataInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&core.VolumeSnapshotData{}, f.defaultInformer)
}
